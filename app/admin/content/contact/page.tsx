...
export default function AdminContactPage() {
    ...
    const handlePhoneChange = (
        type: 'secretary' | 'president',
        value: string
    ) => {
        const formatted = formatPhoneNumber(value);
        setData({
            ...data,
            [type]: { ...data[type], phone: formatted },
        });
    };
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handlePhoneChange('secretary', e.target.value)}
                                maxLength={13}
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handlePhoneChange('president', e.target.value)}
                                maxLength={13}
                                placeholder="010-0000-0000"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue"
                            />
